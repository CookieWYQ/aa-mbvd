package com.cookiewyq.aa_mbvd.world.structure;

import com.cookiewyq.aa_mbvd.AA_MbvdMod;
import com.cookiewyq.aa_mbvd.world.structure.configs.CourtStructureConfig;
import com.cookiewyq.aa_mbvd.world.structure.structures.CourtStructure;
import com.cookiewyq.aa_mbvd.world.structure.structures.HouseStructure;
...
public class ModStructures {
    public static final DeferredRegister<Structure<?>> STRUCTURE = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, AA_MbvdMod.MOD_ID);
    public static final RegistryObject<Structure<NoFeatureConfig>> HOUSE = STRUCTURE.register("house", HouseStructure::new);
    public static final RegistryObject<Structure<CourtStructureConfig>> COURT = STRUCTURE.register("court", CourtStructure::new);
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(HOUSE.get(),
                ...
                true);
        setupMapSpacingAndLand(COURT.get(),
                new StructureSeparationSettings(100,50, 1234567890),
                true);
    }
